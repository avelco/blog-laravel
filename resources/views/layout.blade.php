					...
					<div class="container mx-auto flex items-center">
						...
						<div class="flex w-1/2 pl-4 text-sm">
							<ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
								<li class="mr-2">
									<a class="inline-block py-2 px-2 text-white no-underline hover:underline" href=" {{ route('blog.index') }} ">Inicio</a>
								</li>
								<li class="mr-2">
									<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2" href=" {{ route('blog.category', 'Travel') }} ">Traveling</a>
								</li>
								<li class="mr-2">
									<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2" href=" {{ route('blog.category', 'Programming') }} ">Programming</a>
								</li>
								<li class="mr-2">
									<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2" href=" {{ route('blog.category', 'Inmigration') }} ">Inmigration</a>
								</li>
								<li class="mr-2">
									<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2" href=" {{ route('blog.category', 'Video Games') }} ">Video Games</a>
								</li>
							</ul>
						</div>
